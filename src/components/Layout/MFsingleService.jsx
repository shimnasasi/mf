  ...
  return (
    <>
      <div className="w-full h-64 bg-bannerbg md:px-32">
        <h1 className="text-white px-10 md:px-32 pt-24 text-4xl font-bold">Service</h1>
        <h2 className='text-white mx-32 pt-2 '>Home/Service</h2>
        <h2 className="text-white px-32 pt-2 text-xl"></h2>
      </div>
      <div className="w-full  bg-white">
        <div className=" flex md:px-64 justify-center gap-5 pt-10">
        ...
        <h1 className="text-3xl font-bold px-40 md:px-64 mt-10 text-[#002060]"> Services</h1>
        ...
        <div className="flex flex-wrap gap-8 w-full px-[12rem] pt-14 justify-center ">
          {services.map((list, index) => (
            <div key={index}>
              <div
                className="w-[14.2rem] h-16  border-[#898989] flex justify-center items-center  bg-white
