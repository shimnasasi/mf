    ...
    return (
        <Layout>
            <div className='w-full h-64 bg-bannerbg px-32'>
                <h1 className="text-white mx-32 pt-24 text-5xl font-bold">Services</h1>
            ...
            <div className='w-full h-[85rem] bg-white'>
            <div className='flex'>
                <div className='w-[30rem] h-80 bg-design ml-60 mt-10 bg-center bg-cover hover:scale-105 duration-1000'>
                </div>
                <div className='w-[30rem] h-80 bg-[#002060] mt-10'>
            ...
            <div className='flex'>
                ...
                <div className='w-[30rem] h-80 bg-[#002060] ml-60 '>
                    <h1 className='text-3xl text-white mt-10 ml-16 font-bold'>CNC Programming</h1>
                    <ul className='text-white ml-16 mt-5'>
                        <li>Milling</li>
                        <li>Turning</li>
                ...
                <div className='w-[30rem] h-80 bg-cam bg-center bg-cover hover:scale-105 duration-1000  '>
                </div>
            </div>
            <div className='flex'>
                <div className='w-[30rem] h-80 bg-documentation bg-cover bg-center ml-60 hover:scale-105 duration-1000'>
                </div>
                <div className='w-[30rem] h-80 bg-[#002060]'>
                    <h1 className='text-3xl text-white mt-10 ml-16 font-bold'>Engineering Documentation</h1>
                    <ul className='text-white ml-16 mt-5'>
            ...
            <div className='flex'>
                ...
                <div className='w-[30rem] h-80 bg-[#002060] ml-60'>
                    <h1 className='text-3xl text-white mt-10 ml-16 font-bold'>Other Services</h1>
                    <ul className='text-white ml-16 mt-5'>
                ...
                <div className='w-[30rem] h-80 bg-other-service bg-center bg-cover hover:scale-105 duration-1000 '>
                </div>
            </div>
            </div>
